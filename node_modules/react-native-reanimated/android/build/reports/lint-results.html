...
<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
  <header class="mdl-layout__header">
    <div class="mdl-layout__header-row">
      <span class="mdl-layout-title">Lint Report: 8 warnings</span>
      <div class="mdl-layout-spacer"></div>
      <nav class="mdl-navigation mdl-layout--large-screen-only">
Check performed at Thu Nov 28 23:30:58 IST 2019      </nav>
    </div>
  </header>
  <div class="mdl-layout__drawer">
    ...
    <nav class="mdl-navigation">
      ...
      <a class="mdl-navigation__link" href="#RtlHardcoded"><i class="material-icons warning-icon">warning</i>Using left/right instead of start/end attributes (6)</a>
    </nav>
  </div>
...
<tr><td></td><td class="categoryColumn"><a href="#MissingIssues">Disabled Checks (32)</a>
</td></tr></table>
<br/>              </div>
...
<span class="location"><a href="../../build.gradle">../../build.gradle</a>:34</span>: <span class="message">A newer version of androidx.transition:transition than 1.1.0 is available: 1.2.0</span><br /><pre class="errorlines">
<span class="lineno">  31 </span>
<span class="lineno">  32 </span>dependencies {
<span class="lineno">  33 </span>    implementation <span class="string">'com.facebook.react:react-native:+'</span>
<span class="caretline"><span class="lineno">  34 </span>    <span class="warning">implementation <span class="string">"androidx.transition:transition:1.1.0"</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno">  35 </span>}
<span class="lineno">  36 </span>
<span class="lineno">  37 </span><span class="keyword">def</span> configureReactNativePom(<span class="keyword">def</span> pom) {
</pre>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../build.gradle">../../build.gradle</a>:33</span>: <span class="message">Avoid using + in version numbers; can lead to unpredictable and unrepeatable builds (com.facebook.react:react-native:+)</span><br /><pre class="errorlines">
<span class="lineno">  30 </span>}
<span class="lineno">  31 </span>
<span class="lineno">  32 </span>dependencies {
<span class="caretline"><span class="lineno">  33 </span>    <span class="warning">implementation <span class="string">'com.facebook.react:react-native:+'</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno">  34 </span>    implementation <span class="string">"androidx.transition:transition:1.1.0"</span>
<span class="lineno">  35 </span>}
</pre>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../src/main/java/com/swmansion/reanimated/transitions/TransitionUtils.java">../../src/main/java/com/swmansion/reanimated/transitions/TransitionUtils.java</a>:66</span>: <span class="message">Use "<code>Gravity.END</code>" instead of "<code>Gravity.RIGHT</code>" to ensure correct behavior in right-to-left locales</span><br /><pre class="errorlines">
<span class="lineno">  63 </span>    } <span class="keyword">else</span> <span class="keyword">if</span> (<span class="string">"slide-bottom"</span>.equals(type)) {
<span class="lineno">  64 </span>      <span class="keyword">return</span> <span class="keyword">new</span> Slide(Gravity.BOTTOM);
<span class="lineno">  65 </span>    } <span class="keyword">else</span> <span class="keyword">if</span> (<span class="string">"slide-right"</span>.equals(type)) {
<span class="caretline"><span class="lineno">  66 </span>      <span class="keyword">return</span> <span class="keyword">new</span> Slide(Gravity.<span class="warning">RIGHT</span>);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno">  67 </span>    } <span class="keyword">else</span> <span class="keyword">if</span> (<span class="string">"slide-left"</span>.equals(type)) {
<span class="lineno">  68 </span>      <span class="keyword">return</span> <span class="keyword">new</span> Slide(Gravity.LEFT);
<span class="lineno">  69 </span>    }
</pre>

<span class="location"><a href="../../src/main/java/com/swmansion/reanimated/transitions/TransitionUtils.java">../../src/main/java/com/swmansion/reanimated/transitions/TransitionUtils.java</a>:68</span>: <span class="message">Use "<code>Gravity.START</code>" instead of "<code>Gravity.LEFT</code>" to ensure correct behavior in right-to-left locales</span><br /><pre class="errorlines">
<span class="lineno">  65 </span>    } <span class="keyword">else</span> <span class="keyword">if</span> (<span class="string">"slide-right"</span>.equals(type)) {
<span class="lineno">  66 </span>      <span class="keyword">return</span> <span class="keyword">new</span> Slide(Gravity.RIGHT);
<span class="lineno">  67 </span>    } <span class="keyword">else</span> <span class="keyword">if</span> (<span class="string">"slide-left"</span>.equals(type)) {
<span class="caretline"><span class="lineno">  68 </span>      <span class="keyword">return</span> <span class="keyword">new</span> Slide(Gravity.<span class="warning">LEFT</span>);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno">  69 </span>    }
<span class="lineno">  70 </span>    <span class="keyword">throw</span> <span class="keyword">new</span> JSApplicationIllegalArgumentException(<span class="string">"Invalid transition type "</span> + type);
<span class="lineno">  71 </span>  }
</pre>

<span class="location"><a href="../../src/main/java/com/swmansion/reanimated/transitions/TransitionUtils.java">../../src/main/java/com/swmansion/reanimated/transitions/TransitionUtils.java</a>:111</span>: <span class="message">Use "<code>Gravity.END</code>" instead of "<code>Gravity.RIGHT</code>" to ensure correct behavior in right-to-left locales</span><br /><pre class="errorlines">
<span class="lineno"> 108 </span>    } <span class="keyword">else</span> <span class="keyword">if</span> (<span class="string">"slide-bottom"</span>.equals(type)) {
<span class="lineno"> 109 </span>      <span class="keyword">return</span> <span class="keyword">new</span> Slide(Gravity.BOTTOM);
<span class="lineno"> 110 </span>    } <span class="keyword">else</span> <span class="keyword">if</span> (<span class="string">"slide-right"</span>.equals(type)) {
<span class="caretline"><span class="lineno"> 111 </span>      <span class="keyword">return</span> <span class="keyword">new</span> Slide(Gravity.<span class="warning">RIGHT</span>);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 112 </span>    } <span class="keyword">else</span> <span class="keyword">if</span> (<span class="string">"slide-left"</span>.equals(type)) {
<span class="lineno"> 113 </span>      <span class="keyword">return</span> <span class="keyword">new</span> Slide(Gravity.LEFT);
<span class="lineno"> 114 </span>    }
</pre>

<span class="location"><a href="../../src/main/java/com/swmansion/reanimated/transitions/TransitionUtils.java">../../src/main/java/com/swmansion/reanimated/transitions/TransitionUtils.java</a>:113</span>: <span class="message">Use "<code>Gravity.START</code>" instead of "<code>Gravity.LEFT</code>" to ensure correct behavior in right-to-left locales</span><br /><pre class="errorlines">
<span class="lineno"> 110 </span>    } <span class="keyword">else</span> <span class="keyword">if</span> (<span class="string">"slide-right"</span>.equals(type)) {
<span class="lineno"> 111 </span>      <span class="keyword">return</span> <span class="keyword">new</span> Slide(Gravity.RIGHT);
<span class="lineno"> 112 </span>    } <span class="keyword">else</span> <span class="keyword">if</span> (<span class="string">"slide-left"</span>.equals(type)) {
<span class="caretline"><span class="lineno"> 113 </span>      <span class="keyword">return</span> <span class="keyword">new</span> Slide(Gravity.<span class="warning">LEFT</span>);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 114 </span>    }
<span class="lineno"> 115 </span>    <span class="keyword">throw</span> <span class="keyword">new</span> JSApplicationIllegalArgumentException(<span class="string">"Invalid transition type "</span> + type);
<span class="lineno"> 116 </span>  }
</pre>

<span class="location"><a href="../../src/main/java/com/swmansion/reanimated/transitions/TransitionUtils.java">../../src/main/java/com/swmansion/reanimated/transitions/TransitionUtils.java</a>:145</span>: <span class="message">Use "<code>Gravity.END</code>" instead of "<code>Gravity.RIGHT</code>" to ensure correct behavior in right-to-left locales</span><br /><pre class="errorlines">
<span class="lineno"> 142 </span>      } <span class="keyword">else</span> <span class="keyword">if</span> (<span class="string">"bottom"</span>.equals(propagation)) {
<span class="lineno"> 143 </span>        sidePropagation.setSide(Gravity.TOP);
<span class="lineno"> 144 </span>      } <span class="keyword">else</span> <span class="keyword">if</span> (<span class="string">"left"</span>.equals(propagation)) {
<span class="caretline"><span class="lineno"> 145 </span>        sidePropagation.setSide(Gravity.<span class="warning">RIGHT</span>);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 146 </span>      } <span class="keyword">else</span> <span class="keyword">if</span> (<span class="string">"right"</span>.equals(propagation)) {
<span class="lineno"> 147 </span>        sidePropagation.setSide(Gravity.LEFT);
<span class="lineno"> 148 </span>      }
</pre>

<span class="location"><a href="../../src/main/java/com/swmansion/reanimated/transitions/TransitionUtils.java">../../src/main/java/com/swmansion/reanimated/transitions/TransitionUtils.java</a>:147</span>: <span class="message">Use "<code>Gravity.START</code>" instead of "<code>Gravity.LEFT</code>" to ensure correct behavior in right-to-left locales</span><br /><pre class="errorlines">
<span class="lineno"> 144 </span>      } <span class="keyword">else</span> <span class="keyword">if</span> (<span class="string">"left"</span>.equals(propagation)) {
<span class="lineno"> 145 </span>        sidePropagation.setSide(Gravity.RIGHT);
<span class="lineno"> 146 </span>      } <span class="keyword">else</span> <span class="keyword">if</span> (<span class="string">"right"</span>.equals(propagation)) {
<span class="caretline"><span class="lineno"> 147 </span>        sidePropagation.setSide(Gravity.<span class="warning">LEFT</span>);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 148 </span>      }
<span class="lineno"> 149 </span>      transition.setPropagation(sidePropagation);
